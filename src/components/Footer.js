...
const Footer = () => {
	return (
		<div className="w-full bg-secondary h-[150px] flex flex-col justify-center items-center gap-y-5 text-light">
			...
			<div>Designed and developed by Michał Szczepański, 2024</div>
		</div>
	);
};
